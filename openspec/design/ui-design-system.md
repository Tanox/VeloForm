...
| 版本       | 日期       | 变更内容                                                                          |
| ---------- | ---------- | --------------------------------------------------------------------------------- |
| **v4.4.0** | 2026-08-02 | 安全加固、storage/supabase 测试、动画常量统一、删死代码 |
| **v4.3.1** | 2026-08-02 | UI 修复：遮挡/溢出/对比度/骨架屏 |
| **v4.3.0** | 2026-08-01 | 删除废弃 store 层、i18n 补全、容器语义化 id、测试补齐 |
| **v4.2.2** | 2026-07-30 | 测试与持久化鲁棒性修复、版本号统一至 v4.2.2 |
| v4.2.1 | 2026-07-28 | 工业奢华设计系统完善、DelightLayer微交互、@base-ui/react集成 |
| v4.2.0 | 2026-07-17 | 工业奢华风格、烧锡色品牌、SF Pro字体、深浅双模式 |
| **v4.1.0** | 2026-07-10 | 极简主义重构、与 shadcn/ui base-nova 完全对齐、移除过度装饰、系统字体栈、克制阴影 |
