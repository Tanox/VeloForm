...
| 规范版本 | 项目版本 | 更新日期 | 说明 |
|---------|---------|---------|------|
| v4.4.2 | 4.4.2 | 2026-08-12 | 修复 supabase 保存逻辑误判、移除死依赖 next-pwa、同步文档版本与 Vitest 版本、修正 vitest 池为 forks |
| v4.4.1 | 4.4.1 | 2026-08-09 | 修复 CSP 头、优化静态生成、i18n 补全、测试与类型稳定 |
| v4.4.0 | 4.4.0 | 2026-08-02 | 安全加固（保存校验/移除 unsafe-eval）、storage/supabase-service 测试、动画常量统一、删死代码 |
| v4.3.1 | 4.3.1 | 2026-08-02 | UI 修复：ComparePanel 遮挡、Hero 溢出、ShareModal 滚动、对比度、骨架屏 |
