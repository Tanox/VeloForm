...
export function Hero({ onNavigate }: HeroProps) {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute top-0 left-0 right-0 h-1/2 bg-gradient-to-b from-primary/5 via-transparent to-transparent" aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
        ...
        >
          {/* 外发光边框 */}
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 via-transparent to-accent/20 rounded-3xl blur-xl opacity-50" aria-hidden="true" />

          {/* 主卡片 */}
          <div className="relative rounded-2xl overflow-hidden border border-border-light shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent z-10 pointer-events-none" aria-hidden="true" />
            ...
            {/* 装饰性浏览器标签栏 */}
            <div className="absolute top-0 left-0 right-0 h-10 bg-surface-secondary/80 backdrop-blur-sm flex items-center px-4 gap-2 z-20" aria-hidden="true">
